...
public class DataPusher implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Optional<RequestType> rOptional=requestTypeRepository.findById(1);
		if(!rOptional.isPresent()) {
			RequestType requestType1 = new RequestType(1, "REQ01", "Check", "Request Checkbook",1);
			RequestType requestType2 = new RequestType(2, "REQ02", "Loan", "Request Loan",1);
			RequestType requestType3 = new RequestType(3, "REQ03", "Credit", "Request CreditCard",1);
