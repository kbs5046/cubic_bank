...
public class EmailServiceImpl implements EmailService{
	...
	@Override
	@Async("threadPool")
	public String sendCheckBookRequestEmail(EmailVO mail)  {
		try {
		    MimeMessage message = javaMailSender.createMimeMessage();
	        MimeMessageHelper helper = new MimeMessageHelper(message,
	                MimeMessageHelper.MULTIPART_MODE_MIXED_RELATED,
	        ...
	        props.put("sign", "Banking Application");
	        props.put("location", "Fremont CA100 , USA");
	        props.put("email", "r.sitaula37@gmail.com");
	        props.put("address", "3911 block dr. irving tx,75038");
	        context.setVariables(props);
	        String html = templateEngine.process("checkbook-request-template", context);
	        helper.setTo(mail.getTo());
	        helper.setText(html, true);
	        helper.setSubject(mail.getSubject());
	        helper.setFrom(mail.getFrom());
